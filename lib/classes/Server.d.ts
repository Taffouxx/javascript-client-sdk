...
import type { Server as APIServer, Category, DataBanCreate, DataCreateEmoji, DataCreateServerChannel, DataEditRole, DataEditServer, Override, Role } from "stoat-api";
...
export declare class Server {
     ...
     */
    setRoleOrdering(roleIds: string[]): Promise<void>;
    /**
     ...
     */
    editRole(roleId: string, data: DataEditRole): Promise<ServerRole>;
    /**
     * Delete role
     * @param roleId Role ID
     */
    ...
    syncMembers(excludeOffline?: boolean, excludeOfflineUserCap?: number): Promise<void>;
    /**
